        ...
        <div className="flex justify-between items-center text-base gap-8">
          ...
          >
            <img
              src={logo}
              alt=""
              className="w-40 inline-block items-center space-x-3"
            />
          </a>
          ...
          <div className="space-x-12 hidden lg:flex items-center">
            ...
            <button className="bg-brandPrimary text-white py-2 px-4 transition-all duration-300 rounded hover:bg-netralGrey">
              Sign Up
            </button>
          </div>
          ...
          <div className="md:hidden">
            <button
              onClick={toggleMenu}
              className=" text-netralDGrey focus:outline-none focus:text-gray-500"
            >
              {isMenuOpen ? (
        ...
        >
          {navItems.map(({ link, path }) => (
            <Link
              ...
              offset={-100}
              key={path}
              className="block text-base text-white text-gray900 hover:text-brandPrimary first:font-medium"
            >
              {link}
            </Link>
          ))}
